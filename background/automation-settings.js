...
export const VISIBILITY_SETTINGS_VERSION = 4;
...
export function getDefaultAutomationSettings(extensionName) {
  return {
    ...
    visibility: {
      ...
      mode: VISIBILITY_MODES.SEAMLESS,
      windowWidth: 520,
      windowHeight: 760
    },
    model: {
...
function migrateVisibilitySettings(visibility, defaults) {
  ...
  const mode = visibility.focusDuringRun === true
    ? VISIBILITY_MODES.FOCUSED
    : VISIBILITY_MODES.SEAMLESS;
