...
export function summarizeRequestForDebug(request) {
  return {
    ...
    automationTargetType: request.automationTargetType || null,
    parentRequestId: request.parentRequestId || null,
    conversationMode: request.conversationMode || null,
    chatConversationUrl: request.chatConversationUrl || null,
    chatConversationKey: request.chatConversationKey || null,
